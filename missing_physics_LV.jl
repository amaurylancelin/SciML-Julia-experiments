using Pkg
# Pkg.add(["OrdinaryDiffEq", "ModelingToolkit", "DataDrivenDiffEq", "SciMLSensitivity", "DataDrivenSparse", "Optimization", "OptimizationOptimisers", "OptimizationOptimJL", "LineSearches", "LinearAlgebra", "Statistics", "ComponentArrays", "Lux", "Zygote", "Plots", "StableRNGs"])
